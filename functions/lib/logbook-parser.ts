...
export function parseLogbookFile(buffer: ArrayBuffer | Uint8Array, fileName: string): ParsedLogbook {
...
export function parseLogbookFolder(files: { fileName: string; buffer: ArrayBuffer | Uint8Array }[]): ParsedLogbook[] {
  return files
